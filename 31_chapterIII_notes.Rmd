...
# libraries needed
libs <- c("tinytex", "ggplot2", "dplyr", "tidyr", "rlang", "usethis", "bookdown", "knitr", "rmarkdown", "spelling", "reticulate")
...
# for python modules (not currently functional)
...
```{r diffusion, echo=TRUE, cache=TRUE, evaluate = FALSE}
