...
Import GPS data points saved in the G-drive (collected using Field Maps
and downloaded through Arc Online). Transform into NAD83 zone 15N.
...
## Mass Balnce of 210-Pb

```{r}
1 - exp(log(2)/22.3 * 22.3)

```


$$
A_{\text{total}} = \int_0^\infty R \cdot e^{-\lambda t} \, dt = \frac{R}{\lambda}
$$

$$
\text{Fraction} = \frac{A_{\text{recent}}}{A_{\text{total}}} = 1 - e^{-\lambda \cdot 22.3}
$$

$$
\text{Fraction deposited in last } T \text{ years} = 1 - e^{-\lambda T}
$$
