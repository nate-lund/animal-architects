...
arb_gps_raw <- read.csv("C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/_transect_gps/Erosion_Pin_Transects_1.csv") %>% 
  select(Latitude, Longitude) %>% 
  filter(Latitude < 45) # arb and lr are in the same file, split into 2
  
#C:/Users/natha/OneDrive/Onedrive Documents

lr_gps_raw <- read.csv("C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/_transect_gps/Erosion_Pin_Transects_1.csv") %>% 
  select(Latitude, Longitude) %>% 
  filter(Latitude > 45)
...
write_sf(arb_NAD, "C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/_arb_geo_data_shp/arb_geo_data.shp")
write_sf(lr_NAD, "C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/_lr_geo_data_shp/lr_geo_data.shp")

# export as tables (.csv)
write.csv(arb_NAD, "C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/arb_geo_data.csv", quote = 1)
write.csv(lr_NAD, "C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/lr_geo_data.csv", quote = 1)
```
...
``` r
# import shape files
arb_geo_shp <- read_sf("C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/_arb_geo_data_shp/arb_geo_data.shp")
lr_geo_shp <- read_sf("C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/_lr_geo_data_shp/lr_geo_data.shp")

# import elevation slope curvature data
arb_geo_data <- read.csv("C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/arb_geo_data.csv")
lr_geo_data <- read.csv("C:/Users/natha/OneDrive/Onedrive Documents/_data/_erosion_pins/lr_geo_data.csv")
